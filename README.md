...
1. Download [the asset file](https://github.com/cosinepi/aws-simple-icons-affinity-designer-asset/blob/master/Asset/AWS_Simple_Icons_EPS-SVG_v16.2.22.afassets?raw=true).
